...
function Show() {
  ...
  function handleConfirmarUbicacion(e) {
    ...
    if (butacaSeleccionadasPlateaBaja.length > 0) {
      axios
        .post("http://localhost:8000/actualizar-ubicaciones-platea-baja", {
    ...
    if (butacaSeleccionadasPlateaAlta.length > 0) {
      axios
        .post("http://localhost:8000/actualizar-ubicaciones-platea-alta", {
  ...
  useEffect(() => {
    fetch("http://localhost:8000/butacas-platea-baja")
    ...
    fetch("http://localhost:8000/butacas-platea-alta")
      .then((response) => response.json())
      .then((data) => {
